...
public partial class UI_OPE_frmAltaNC : System.Web.UI.Page
{
    ...
    protected void Unnamed1_Click(object sender, EventArgs e)
    {
        ...
        {
            clsNanoCreditoNeg objNanoCredito = new clsNanoCreditoNeg();
            Int32 CODCABNANOCREDITO = Int32.MinValue;
            ...
            if (CODCABNANOCREDITO > 0)
            {
                ...
                ArrayList _lstRespuesta = objNanoCredito.RealizarPagoNanoCredito(CODCABNANOCREDITO, pusuario);
                rptCliente.DataSource = objNanoCredito.ConsultarNanoCredito(Convert.ToDateTime(dtxtFechaDesde.Text));
                rptCliente.DataBind();
