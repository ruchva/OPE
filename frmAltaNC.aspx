<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmAltaNC.aspx.cs" Inherits="UI_OPE_frmAltaNC" %>
...
<% } %> 
    ...
    <fieldset class="search" style="height: 70%">
            <dx:ASPxLabel ID="dlblTitulo" runat="server" Font-Size="130%" Font-Bold="True"
                            ForeColor="#337447"  Font-Underline="True" Text="Procesamiento de Alta PDV">
                        </dx:ASPxLabel>
            <table>            
            <tr>
            <td>
        ...
        <asp:Button runat="server" Text="Procesar Alta PDV" BackColor="#337447" ForeColor="White" OnClick="Unnamed1_Click" width="178px" />         
        <table style="border: 0; width: 100%;visibility:hidden">
            ...
            <tr>
                <td>                    
                    <asp:Button runat="server" Text="Procesar Alta PDV" OnClick="Unnamed1_Click" />
                </td>
            </tr>
        </table>
